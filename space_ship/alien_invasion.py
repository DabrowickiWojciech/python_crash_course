...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        '''Starts a nwe game when the player click play.'''  
    ...
    def _update_bullets(self):
        '''Update position of bullets and get rid of them'''
    ...
    def _check_bullet_alien_colision(self):
        ...
        #Remove any bullet that has colided 
    ...
    def _create_fleet(self):
        ...
        #Create the full fliet of aliens
    ...
    def _update_aliens(self):
        ...
        #Chech for aliens hitting bottom of the screen
